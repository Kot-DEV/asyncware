...
*/
		...
		boolean isXd = Asyncware.instance.settingsManager.getSettingByName("Lunk").getValBoolean();
		...
		if (isCsgo) {
			...
			if (neverlose) {
				...
				Gui.drawRect(Asyncware.instance.csgoRenderer.getStringWidth("asyncware | " + mc.thePlayer.getName() + " | " + Time.getTime(System.currentTimeMillis(), "HH:mm:ss")) + 30D, 20D, 20D, 3D, new Color(9, 19, 34, 167).getRGB());
				GlStateManager.translate(0f, 23f, 0);
				Gui.drawRect(Asyncware.instance.csgoRenderer.getStringWidth("asyncware | " + mc.thePlayer.getName() + " | " + Time.getTime(System.currentTimeMillis(), "HH:mm:ss")) + 30D, -20D, 20D, -19D, Colors.Astolfo(100, 1.0f, 0.5f));
				GlStateManager.popMatrix();

				Asyncware.csgoRenderer.drawString("a", 10, 12, Colors.Astolfo(100, 1.0f, 0.5f), false);
				Asyncware.csgoRenderer.drawString("syncware | " + mc.thePlayer.getName() + " | " + Time.getTime(System.currentTimeMillis(), "HH:mm:ss"), 14, 12, -1, false);

			} else {
				GlStateManager.pushMatrix();
				GlStateManager.translate(-14f, 4f, 0);
				Gui.drawRect(Asyncware.instance.csgoRenderer.getStringWidth("asyncware | " + mc.thePlayer.getName() + " | " + Time.getTime(System.currentTimeMillis(), "HH:mm:ss")) + 31D, 21D, 19D, 2D, Colors.RGB());

				gui.drawGradientRect(Asyncware.instance.csgoRenderer.getStringWidth("asyncware | " + mc.thePlayer.getName() + " | " + Time.getTime(System.currentTimeMillis(), "HH:mm:ss")) + 30D, 20D, 20D, 3D, new Color(24, 24, 24, 255).getRGB(), new Color(15, 15, 15, 255).getRGB());

				GlStateManager.translate(0f, 23f, 0);
				//Gui.drawRect(Asyncware.instance.csgoRenderer.getStringWidth("asyncware | " + mc.thePlayer.getName() + " | " + Time.getTime(System.currentTimeMillis(), "HH:mm:ss")) + 30D, -20D, 20D, -19D, Colors.RGB());
				GlStateManager.popMatrix();

				Asyncware.csgoRenderer.drawString("a", 10, 12, Colors.RGB(), false);
				Asyncware.csgoRenderer.drawString("syncware | " + mc.thePlayer.getName() + " | " + Time.getTime(System.currentTimeMillis(), "HH:mm:ss"), 14, 12, -1, false);
			...
			if(Asyncware.instance.moduleManager.getModuleByName("Jello").isToggled()){
				...
				Asyncware.renderer.drawString("A", 2, 2, Colors.Astolfo(100, 1.0f, 0.5f), true);
				Asyncware.renderer.drawString("syncware ", 9, 2, -1, true);
			}
			...
			for(Module m : enabledMods) {
				...
				//	Gui.drawRect(sr.getScaledWidth() - Asyncware.renderer.getStringWidth(m.getDisplayName()) + -12, y - 4, sr.getScaledWidth(),  4 +  Asyncware.renderer.getFontHeight() + y + 2 , Colors.Astolfo(count * 100, 1.0f, 0.5f));
					if(arrStyle.equalsIgnoreCase("Gamesense")){
						...
						Gui.drawRect(sr.getScaledWidth() - Asyncware.renderer.getStringWidth(m.getDisplayName()) - 10, y - 1, sr.getScaledWidth(), 2 + Asyncware.renderer.getFontHeight() + y, new Color(12, 12, 12, 255).getRGB());
						...
						//Gui.drawRect(sr.getScaledWidth() - Asyncware.renderer.getStringWidth(m.getDisplayName()) - 10, y - 1, sr.getScaledWidth(),  0 +  Asyncware.renderer.getFontHeight() + y , new Color(20, 20, 20, 120).getRGB());
						GlStateManager.pushMatrix();
						Gui.drawRect(sr.getScaledWidth() - Asyncware.renderer.getStringWidth(m.getDisplayName()) - 10, y - 1, sr.getScaledWidth(), 2 + Asyncware.renderer.getFontHeight() + y, new Color(9, 19, 34, 167).getRGB());
						//Gui.drawRect(sr.getScaledWidth() - mc.fontRendererObj.getStringWidth(m.getDisplayName())  - 8, count * (this.mc.fontRendererObj.FONT_HEIGHT + 6), sr.getScaledWidth(), 6 + this.mc.fontRendererObj.FONT_HEIGHT + count * (this.mc.fontRendererObj.FONT_HEIGHT + 6), new Color(24, 24, 24,255).getRGB());
						...
						Gui.drawRect(958, count * (this.mc.fontRendererObj.FONT_HEIGHT + 6), 960, 7 + this.mc.fontRendererObj.FONT_HEIGHT + count * (this.mc.fontRendererObj.FONT_HEIGHT + 6), Colors.RGBX(2, 1.0f, 0.5f, count * 120));
				...
				if(isFont){
					...
					Asyncware.renderer.drawString(m.getDisplayName(), sr.getScaledWidth() - Asyncware.renderer.getStringWidth(m.getDisplayName()) - 7, y + 1, Colors.RGBX(2, 1.0f, 0.5f, count * 120), true);
