                ...
                switch (enumaction)
                {
                    ...
                    case BLOCK:
                        ...
                        SwordAnimation sword = new SwordAnimation();
                            ...
                            GL11.glRotated((-f8 * 70.0F), (f8 / 2.0F), 0.0D, 7.0D);
                            GL11.glRotated((-f8 * 60.0F), 0.800000011920929D, (f8 / 2.0F), 0.0D);
                            func_178103_d();
                            break;
                        ...
                        if(!Asyncware.instance.moduleManager.getModuleByName("SwordAnimation").isToggled() && !sword.isToggled()){
                            this.transformFirstPersonItem(f, 0.0F);
                            this.func_178103_d();
                        }
